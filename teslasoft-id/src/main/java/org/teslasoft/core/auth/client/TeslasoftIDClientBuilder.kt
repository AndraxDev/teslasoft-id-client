...
import org.teslasoft.core.auth.ApplicationSignature
...
class TeslasoftIDClientBuilder(private val context: Activity) {
    ...
    fun build() : TeslasoftIDClient {
        ...
        teslasoftIDClient = TeslasoftIDClient(context, applicationSignature.certificateSHA256Fingerprint!!, apiKey!!, appId!!, settingsListener, syncListener)
