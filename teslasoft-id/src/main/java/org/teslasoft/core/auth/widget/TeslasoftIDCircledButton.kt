...
class TeslasoftIDCircledButton : Fragment() {
    ...
    private fun sync(uid : String?, sig : String?) {
        ...
        verificationApi?.startRequestNetwork(RequestNetworkController.GET, "https://id.teslasoft.org/xauth/GetAccountInfo.php?sig=$sig&uid=$uid&token=$token", "A", verificationApiListener)
    }
